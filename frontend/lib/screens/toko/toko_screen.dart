      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            const SizedBox(width: 8),
            Text('🎤 Scan Suara', style: TextStyle(color: textColor)),
          ],
        ),
        content: Column(
          ...
          children: [
            Text(
              'Ucapkan produk yang ingin ditambahkan:',
            ...
            Container(
              ...
              child: const Text(
                'Contoh: "Beli mie goreng satu, teh botol dua"',
            ...
            TextField(
              ...
              onSubmitted: (text) {
                Navigator.pop(ctx);
                if (text.isNotEmpty) {
                  context.read<TokoProvider>().processVoiceScan(text);
                }
              },
            ),
          ],
